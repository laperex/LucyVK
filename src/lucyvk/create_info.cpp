...
VkPipelineColorBlendAttachmentState lvk::info::color_blend_attachment_additive() {
	return {
    	.blendEnable = VK_TRUE,
...
VkPipelineColorBlendAttachmentState lvk::info::color_blend_attachment_alphablend() {
	return {
		.blendEnable = VK_TRUE,

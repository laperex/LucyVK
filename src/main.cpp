...
int main(int count, char** args) {
	...
	auto device = physical_device.init_device({ VK_KHR_SWAPCHAIN_EXTENSION_NAME });
	...
	auto compute_shader = device.init_shader_module(VK_SHADER_STAGE_COMPUTE_BIT, "/home/laperex/Programming/C++/LucyVK/build/shaders/gradient.comp.spv");
	
	auto compute_pipeline = pipeline_layout.init_compute_pipeline(lvk::info::shader_stage(&compute_shader));
